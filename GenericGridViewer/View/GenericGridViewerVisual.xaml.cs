    ...
    public partial class GenericGridViewerVisual : UserControl
    {
       ...
       // private string MSGBOX_TITLE_ERROR = "Generic Viewer";
        ...
        public void Get_ChartData()
        {
            ...
            ThreadPool.QueueUserWorkItem(
                delegate(object eventArg)
                {
                    ...
                    //AccountTransaction.Tables[0].Columns.Add("CustomColumn1");
                    //AccountTransaction.Tables[0].Columns.Add("CustomColumn2");
                    //AccountTransaction.Tables[0].Columns.Add("CustomColumn3");
                    //AccountTransaction.Tables[0].Columns.Add("CustomColumn4");
                    //AccountTransaction.Tables[0].Columns.Add("CustomColumn5");
                    //AccountTransaction.Tables[0].Columns.Add("CustomColumn6");
                    ...
                    if (AccountTransaction.Tables.Count > 0)
                    {
                        ...
                        Dispatcher.BeginInvoke(new Action(() =>
                        {
                            ...
                            //    gridColumn.AllowUnboundExpressionEditor = true;
                            ...
                            //    if (gridColumn.FieldName == "CustomColumn5" || gridColumn.FieldName == "CustomColumn6")
        ...
        private void AssignXML()
        {
            ...
            //int maxColumnIndex = _dataGrid.Columns.Count - 1;

            //for (int i = maxColumnIndex; i >= 0; i--)
            //{
            //    _dataGrid.Columns.RemoveAt(i);
            //}

namespace BlotterView.Client.View
{
   ...
   using BlotterView.Client.ViewModel;
    ...
    public partial class BlotterViewVisual : UserControl
    {
        ...
        public BlotterViewViewerModel _vm;
        ...
        public int BrokerId
        {
         ...
         public BlotterViewVisual(BlotterViewViewerModel securityHistoryViewerModel)
         {
                ...
                delegate(object eventArg)
                {
                    ...
                    foreach (DataTable table in ds.Tables)
                    {
                        foreach (DataRow row in table.Rows)
                        {
                            ...
                            Dispatcher.BeginInvoke(new Action(() =>
                            {
                                cmboDesk.Items.Add(new BlotterView.Client.ComboBoxItem(Convert.ToString(item), Convert.ToInt64(desk_id)));
        ...
        private void cmboDesk_SelectedIndexChanged(object sender, System.Windows.Controls.SelectionChangedEventArgs e)
        {
            ...
            else
            {
                if (!String.IsNullOrEmpty((cmboDesk.SelectedItem).ToString()))
                {
                    ...
                    DeskId = Convert.ToInt32(((BlotterView.Client.ComboBoxItem)cmboDesk.SelectedItem).HiddenValue);
